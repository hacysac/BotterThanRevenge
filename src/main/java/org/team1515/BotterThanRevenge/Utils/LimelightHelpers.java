...
public class LimelightHelpers {
    ...
    static final String sanitizeName(String name) {
        ...
        SmartDashboard.putString("LL Name", name);
        return name;
    }
    ...
    public static NetworkTable getLimelightNTTable(String tableName) {
        //String blah = NetworkTableInstance.getDefault().getTable(sanitizeName(tableName)).getKeys().stream().collect(Collectors.joining(","));
        //SmartDashboard.putString("Entries", blah);
        Pose3d pos = toPose3D(NetworkTableInstance.getDefault().getTable(sanitizeName(tableName)).getEntry("botpose_wpiblue").getDoubleArray(new double[0]));
        SmartDashboard.putNumber("NTDirectPoseX",pos.getX());
        SmartDashboard.putNumber("NTDirectPoseY",pos.getY());
    ...
    public static String getLimelightNTString(String tableName, String entryName) {
        SmartDashboard.putString("NT", getLimelightNTTableEntry(tableName, entryName).getString(""));
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        ...
        SmartDashboard.putString("Json", getJSONDump(limelightName));
        try {
