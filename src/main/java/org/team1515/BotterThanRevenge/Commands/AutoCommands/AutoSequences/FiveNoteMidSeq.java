...
public class FiveNoteMidSeq extends SequentialCommandGroup{
    public FiveNoteMidSeq(Drivetrain drivetrain, Shooter shooter, Indexer indexer, Intake intake, Flip flip, double direction){        
        ...
        Point finalPose = new Point(Units.inchesToMeters(174.095-RobotMap.SUBWOOFER_DEPTH), 0);
        Point pose4 = new Point(Units.inchesToMeters(191.8-RobotMap.SUBWOOFER_DEPTH), Units.inchesToMeters(-direction*subwooferToNoteY));
        Point pose5 = new Point(Units.inchesToMeters(RobotMap.SUBWOOFER_TO_CENTER), Units.inchesToMeters(-direction*subwooferToNoteY));
