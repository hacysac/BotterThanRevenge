...
public class BetterTwoSpeakerAmp extends SequentialCommandGroup{
    public BetterTwoSpeakerAmp(Drivetrain drivetrain, Shooter shooter, Indexer indexer, Intake intake, Flip flip, double direction){        
