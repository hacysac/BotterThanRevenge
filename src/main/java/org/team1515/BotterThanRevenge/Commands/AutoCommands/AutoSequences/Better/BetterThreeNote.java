...
public class BetterThreeNote extends SequentialCommandGroup{
    public BetterThreeNote(Drivetrain drivetrain, Shooter shooter, Indexer indexer, Intake intake, Flip flip, double direction){        
